...
namespace workshop_Thread_2
{
    internal static class Program
    {
        ...
        {
            //Console.Write("Bonjour mon Hero 2 Coder!");
            ...
            Thread thd_timeInvok = 
                new Thread(new ThreadStart(dlG_time.Invoke));
            ...
            while (!asyncR.IsCompleted) { Console.WriteLine("Travaux en cours..."); Thread.Sleep(5000); }
            Console.Read();
